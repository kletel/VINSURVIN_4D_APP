...
$cave:=ds:C1482.Cave.query("UUID_=:1"; $uuid).toCollection("UUID_,Nom,Type,Pays,Région,Reste_en_Cave,Millesime,Apogee,Valeur_Euro,Appellation,Ref_Cave,Cave,Coup_de_Coeur,Note_sur_20,base64_etiquettecomplet,RemarquesIA,Valeur,Sous_Region,Producteur,Cepage,Alcool,Couleur,Etagere,Flacon,Dont_Bue,Date_Achat,Prix_"+"Achat,Qte,Temperature,valeurCave,Lieu_Achat,Elevage,Apogee_Max,Remarques").first()
