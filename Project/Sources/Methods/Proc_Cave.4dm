...
Open window:C153(0; 70; $Larg; $L_bottom; 8; Get indexed string:C510(<>strLang; 6); "Fermer")

//Creer fenetre(0;190;$Larg;Hauteur ecran;8;◊LangueOff{2};"Fermer")
Bt_Aj:=0
SET MENU BAR:C67(<>Langue)
FORM SET OUTPUT:C54("Liste Cave")
FORM SET INPUT:C55("Liste Cave")
